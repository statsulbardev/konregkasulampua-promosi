            ...
            <div className="mr-2 mt-2 inline-flex">
              <a href="https://facebook.com/bpsprovsultra">
                ...
                >
                  <path
                    fill="currentColor"
                    d="M31 15.539C31 6.96 24.056 0 15.5 0 6.944 0 0 6.961 0 15.539c0 7.52 5.332 13.783 12.4 15.228V20.2H9.3v-4.662h3.1v-3.885c0-2.999 2.434-5.438 5.425-5.438H21.7v4.661h-3.1c-.853 0-1.55.7-1.55 1.554v3.108h4.65V20.2h-4.65V31C24.878 30.223 31 23.604 31 15.539Z"
                  />
                </svg>
              </a>
            </div>
              ...
              <a href="https://youtube.com/bpsprovsultra">
                ...
                >
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
                    d="M15.542 31c8.56 0 15.5-6.94 15.5-15.5 0-8.56-6.94-15.5-15.5-15.5-8.56 0-15.5 6.94-15.5 15.5 0 8.56 6.94 15.5 15.5 15.5Zm3.708-15.113-6.033 3.488V12.4l6.033 3.487Zm7.73-3.406c-.07-.93-.174-1.662-.325-2.208-.29-1.047-.965-1.72-2.01-2.011-1.198-.326-4.232-.512-9.103-.512l-1.849.07c-1.278 0-2.662.035-4.173.116-1.535.07-2.534.174-3.08.325-1.047.291-1.721.965-2.012 2.012-.325 1.197-.511 3.069-.511 5.614l.07.977c0 .697.034 1.5.116 2.43.07.93.174 1.662.325 2.208.29 1.047.965 1.72 2.011 2.012 1.198.325 4.232.511 9.103.511l1.848-.07c1.279 0 2.662-.035 4.173-.116 1.535-.07 2.535-.174 3.081-.325 1.046-.291 1.72-.965 2.011-2.012.326-1.197.512-3.069.512-5.614l-.07-.977c0-.697-.035-1.5-.116-2.43Z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
              ...
              <a href="https://sultra.bps.go.id">
                ...
                >
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
                    d="M15.583 31c8.56 0 15.5-6.94 15.5-15.5 0-8.56-6.94-15.5-15.5-15.5-8.56 0-15.5 6.94-15.5 15.5 0 8.56 6.94 15.5 15.5 15.5Zm5.813-15.5c0 .878-.078 1.73-.181 2.583h4.366c.207-.826.336-1.692.336-2.583 0-.891-.13-1.757-.336-2.583h-4.366c.103.852.18 1.705.18 2.583Zm-.685 5.167a20.21 20.21 0 0 1-1.782 4.598 10.372 10.372 0 0 0 5.593-4.598h-3.81Zm-8.15-2.584h6.045c.116-.852.206-1.705.206-2.583 0-.878-.09-1.744-.206-2.583H12.56a17 17 0 0 0-.207 2.583c0 .878.078 1.73.207 2.583Zm.555 2.584c.53 1.847 1.395 3.565 2.467 5.115 1.072-1.55 1.938-3.268 2.467-5.115h-4.934ZM6.645 10.333h3.772c.452-1.614 1.033-3.164 1.808-4.598a10.234 10.234 0 0 0-5.58 4.598Zm3.772 10.334H6.645a10.344 10.344 0 0 0 5.58 4.598c-.775-1.434-1.356-2.984-1.808-4.598ZM5.25 15.5c0 .891.13 1.757.336 2.583h4.366A21.33 21.33 0 0 1 9.77 15.5c0-.878.077-1.73.18-2.583H5.587A10.646 10.646 0 0 0 5.25 15.5Zm12.8-5.167c-.53-1.847-1.395-3.578-2.467-5.128-1.072 1.55-1.937 3.281-2.467 5.128h4.934Zm2.661 0h3.81a10.316 10.316 0 0 0-5.592-4.598 20.213 20.213 0 0 1 1.782 4.598ZM2.667 15.5c0-7.104 5.773-12.917 12.916-12.917A12.916 12.916 0 1 1 2.667 15.5Z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
            ...
            <div className="mt-8 pt-8 sm:flex sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-4 text-sm text-gray-500 dark:text-[#888888]">
                  ...
                  Provinsi Sulawesi Tenggara. Semua Hak Dilindungi
                </p>
